...
public class GoodsService {
	...
	/**
	 * 초기치 데이터를 세팅하는 메소드 String [][] data = new String [][]{ {"A01" , "새우깡" , "2500"
	 * , "짜고 맛나다."}, //---> Goods {"A02" , "고구마깡" , "3500" , "고구맛이고 달다."}, //--->
	 * Goods {"A03" , "감자깡" , "5000" , "감자맛에 고소한맛."}, // ---> Goods {"A04" , "허니버터칩"
	 * , "2200" , "달콤 하다."}, {"A05" , "콘칩" , "3000" , "고소하다."}
	 * 
	 * };
	 */
	...
	public int insert(Goods goods) {
		...
		// 중복체크
		Goods searchedGoods = this.selectByCode(goods.getCode());
	...
	public boolean update(Goods goods) { 
		Goods find = this.selectByCode(goods.getCode());
		
		if (find == null)
			return false;
		
		find.setPrice(goods.getPrice());
		find.setExplain(goods.getExplain());
		return true;
	}
}