package WS_04_Collection.service;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import WS_04_Collection.dto.AccountDto;
import WS_04_Collection.dto.UserDto;
...
public class BankService {
	...
	public List<AccountDto> getAccountList(int userSeq) { // 100
		...
		ArrayList<AccountDto> searchAccountDtoList = new ArrayList<AccountDto>(searchAccountCount);
