...
public class ElectronicsController {
	...
	public void update(Electronics electronics) {
		try {
			...
			SuccessView.printMessage("제품 수정에 성공했습니다. 제품 번호는 : " + electronics.getModelNo());
		} catch (SearchNotFoundException e) {
			FailView.errorMessage(e.getMessage());
		}
	}
	...
	public void deleteModelNo(int modelNo) {
		try {
			...
			SuccessView.printMessage("제품 삭제에 성공했습니다. 제품 번호 :" + modelNo);
		} catch (SearchNotFoundException e) {
			FailView.errorMessage(e.getMessage());
		}
	}
	...
	public void selectSortByPrice() {
		List<Electronics> sorList = service.selectSortByPrice();
		SuccessView.printAll(sorList);
	}
