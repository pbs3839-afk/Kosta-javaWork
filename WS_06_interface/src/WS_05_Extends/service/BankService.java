package WS_05_Extends.service;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import WS_05_Extends.dto.AccountDto;
import WS_05_Extends.dto.InstallAccountDto;
import WS_05_Extends.dto.LoanAccountDto;
import WS_05_Extends.dto.SavingAccountDto;
import WS_05_Extends.dto.UserDto;
...
public class BankService {
	...
	/**
	 * 5) 신규로, 사용자 일련번호 기준으로 정렬한 모든 계좌 목록을 리턴 하는 메소드를 작성한다. 만약 사용자 일련번호 같으면 잔액을 기준으로
	 * 내림차순!
	 * 
	...
	public List<AccountDto> getAccountListSortByUserSeq() {
		...
		Collections.sort(shallowCopyList, (a, b) -> a.getUserSeq() == b.getUserSeq() ? b.getBalance() - a.getBalance()
