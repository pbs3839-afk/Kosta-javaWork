package subject.db.view;

import java.util.List;

import subject.db.dao.StudentTeacherDAO;
import subject.db.dao.StudentTeacherDAOImpl;
...
public class MainView {
	...
	public static void main(String[] args) {
		...
		if (teacher == null)
			...
			System.out.print(teacher.gettNO() + " | ");
			System.out.print(teacher.gettName() + " | ");

			System.out.print(teacher.getSubject().getTakecode() + " | ");
			System.out.print(teacher.getSubject().getSubject() + " | ");

			System.out.print(teacher.getRoom().getRoomNo() + " | ");
			System.out.print(teacher.getRoom().getCapacity() + "\n");
