...
//		methodExam03_02호출
		...
		void methodExam03_03(int i, String str) {
			...
			String no= this.methodExam03_02(str,i); 
			System.out.println(no);
		}
...
//		method02_04가 리턴하는 값을 리턴
		...
		protected double methodExam03_04(int i, double d, int j) {
			...
			double q = mme.methodExam02_04(i, d, j);
			return q;
...
class UsingMethod{
	...
	public static void main(String []args){
		...
		String b = ume.methodExam03_02("nq", 10);
		System.out.println(b);
		
		ume.methodExam03_03(5, "qb");
		
		double c = ume.methodExam03_04(3, 2.0, 100);
