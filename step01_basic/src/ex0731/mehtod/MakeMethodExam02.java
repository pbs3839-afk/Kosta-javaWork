...
*/
	private int methodExam02_01(int i, int j) {
		if((i+j)%3==0)System.out.println(i+j); {
...
*/
	void methodExam02_03(int a , String u) {
...
/*	
	...
	(구현부에서)하는일 : 첫번째 인수 곱하기 두번째인수 빼기 세번째인수 결과 출력
			     위의 결과를 리턴
*/
	protected double methodExam02_04(int b, double c , int d) {
		double ac = b*c-d;
		System.out.println(ac); return ac;
	}
